   ...
   shadow-xl ">
        <div className="card-body flex flex-col   justify-center">
          ...
          <fieldset className="fieldset ">
            ...
            <button  onClick={handleSignIn} className="btn bg-linear-to-t from-indigo-600 to-indigo-500
        text-white
        mt-4">{loading ? 'Signing in...' : 'Sign in'}</button>
      ...
      <div className='hidden  w-1/2  bg-linear-to-t from-indigo-400 to-indigo-700 rounded-2xl md:flex flex-col p-18'>
        <div className=' text-center text-white'>
          ...
          <p className='text-lg font-bold'>Sign In to continue your fitness journey with us</p>
        </div >
